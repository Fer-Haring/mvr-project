...
import ProductImageHolder from '@webapp/web/controller/product-detail/product-image-holder';
import SimilarProducts from '@webapp/web/controller/product-detail/similar-products';
