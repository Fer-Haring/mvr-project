...
import PaymentTypeButtons from '@webapp/web/controller/cart/step-1/botones-metodo-pago';
import DeliveryTypeButtons from '@webapp/web/controller/cart/step-1/botones-tipo-entrega';
import ZoneDeliverButtons from '@webapp/web/controller/cart/step-1/botones-zona-entrega';
