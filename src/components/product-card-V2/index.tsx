...
import { useAddFavorite } from '@webapp/service/mutations/auth/add-to-favorites-mutation';
import { useGetUserByIdMutation } from '@webapp/service/mutations/auth/get-user-by-id-mutation';
import { useRemoveFavorite } from '@webapp/service/mutations/auth/remove-from-favorites-mutation';
