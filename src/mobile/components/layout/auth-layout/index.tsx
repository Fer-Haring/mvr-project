...
import Card from '@webapp/mobile/components/card';
import LogoHeader from '@webapp/mobile/components/logo-header';
...
const AuthLayout: FunctionComponent<AuthLayoutProps> = ({ className, children }) => {
  return (
    <MainWrapper>
      ...
      >
        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', justifyContent: 'flex-end', p: 4 }}>
          <LanguageSelector />
